...
export const VCardHeader = styled.div`
    ...
    flex-direction: ${(props: ICardPanelProps) => props.headerOrientation || 'row'};
    background: ${(props: ICardPanelProps) => props.headerBackgroundColor || '#E8E8E8'};
    justify-content: ${(props: ICardPanelProps) => props.headerJustifyContent === 'center' ? 'center' :
        props.headerJustifyContent === 'end' ? 'flex-end' : 'flex-start'};
    height: 35px;
    display: flex;
    align-items: center;
    padding: 0 15px;
...
export const VCardTextSpan = styled.span`
    ...
    align-items: center;
	flex-direction: row;
	justify-content: ${(props: ICardPanelProps) => props.headerTextJustify === 'center' ? 'center' :
    props.headerTextJustify === 'end' ? 'flex-end' : 'flex-start'};
	& span {
	    margin: 0 5px 0 0;
	    }
`;
...
export const VCardBody = styled.div`
    background: ${(props: ICardPanelProps) => props.backgroundColor || 'transparent'};

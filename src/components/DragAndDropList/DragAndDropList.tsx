  ...
  const handleItemSelection = (itemId: any, listId: any) => {
    if (props.allowItemSelection) {
      const selectedItemId =
        itemId !== state.selectedItemId?.[listId] ? itemId : '';
      setState({ ...state, selectedItemId: { [listId]: selectedItemId } });
                                  ...
                                  {(
                                    ...
                                    <DNDItemWrapper
                                      ...
                                      className={`${state.selectedItemId &&
                                        state.selectedItemId?.[value.id] === item.value &&
                                        'dndItemSelected'}`}
                                      providedDraggable={providedDraggable}
                                      item={item}
                                      displayButtons={
                                        props.showHelpButtons &&
                                        item.value === state.selectedItemId?.[value.id]
                                      }
